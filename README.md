...
The application runs a speed test on a set interval and stores the result. The results are then display on a filtered chart, to provide a quick overview of network performance.
